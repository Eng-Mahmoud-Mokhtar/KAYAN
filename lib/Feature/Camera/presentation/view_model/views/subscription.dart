...
import 'package:homepage/Feature/Camera/presentation/view_model/views/widgets/confirmationCamera.dart';
import 'package:table_calendar/table_calendar.dart';
import '../../../../core/utiles/constans.dart';


class SubscribeCamera extends StatefulWidget {
  const SubscribeCamera({super.key});
  @override
  State<SubscribeCamera> createState() => _SubscribeCameraState();
}

class _SubscribeCameraState extends State<SubscribeCamera> {
                ...
                onPressed: () {
                  ...
                  if (selectedDay != null && selectedTime != null) {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => ConfirmationCamera(),
                      ),
                    );
                  } else {
