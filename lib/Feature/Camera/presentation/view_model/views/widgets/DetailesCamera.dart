...
class DetailsCamera extends StatefulWidget {
  ...
  @override
  State<DetailsCamera> createState() => _DetailsCameraState();
}

class _DetailsCameraState extends State<DetailsCamera> {
  int _rating = 5;
  ...
  final List<String> _videoPaths = [
    'images/Gym/videoGym1.mp4',
    'images/Gym/videoGym2.mp4',
  ];
  @override
  void initState() {
    super.initState();
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              minimumSize: Size(screenWidth * 0.9, 50), backgroundColor: !_showFeatures && !_showVideos ? KprimaryColor : Colors.grey[800],
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              minimumSize: Size(screenWidth * 0.9, 50), backgroundColor: _showVideos ? KprimaryColor : Colors.grey[800],
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(8),
                              ),
                            ),
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              minimumSize: Size(screenWidth * 0.9, 50), backgroundColor: _showFeatures ? KprimaryColor : Colors.grey[800],
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(8),
                              ),
                            ),
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SubscribeCamera(),
                      ),
                    );
                  },
                  child: Text(
  ...
  Widget _buildFeatures() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.end,
        children: [
          _buildFeatureRow('موجود', 'أجهزة تمرين حديثة'),
          _buildFeatureRow('موجود', 'مساحة لليوغا والبيلاتس'),
          _buildFeatureRow('موجود', 'مدربون معتمدون'),
          _buildFeatureRow('موجود', 'خدمات الاستحمام'),
          _buildFeatureRow('غير موجود', 'حمام سباحة'),
        ],
      ),
    );
  }
        ...
        children: [
          Container(
            ...
            child: ListView(
              scrollDirection: Axis.horizontal,
              children: [
                _buildImage('images/224a2022f8bf8588f2db862c377921f8.jpg'),
                _buildImage('images/Service/medium-shot-man-taking-photos.jpg'),
                _buildImage('images/Service/portrait-cheerful-photographer-studio.jpg'),
                _buildImage('images/Service/professional-indian-young-photographer-taking-photos-studio-with-leight.jpg'),
              ],
            ),
          ),
        ],
