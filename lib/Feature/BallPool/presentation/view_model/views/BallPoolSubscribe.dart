...
import 'confirmationBallPool.dart';

class BallPoolSubscribe extends StatefulWidget {
  const BallPoolSubscribe({super.key});
  @override
  State<BallPoolSubscribe> createState() => _BallPoolSubscribeState();
}

class _BallPoolSubscribeState extends State<BallPoolSubscribe> {
                ...
                onPressed: () {
                  ...
                  if (selectedDay != null && selectedTime != null) {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => ConfirmationBallPool(),
                      ),
                    );
                  } else {
