...
import 'package:homepage/Feature/BallPool/presentation/view_model/views/transfer_amount.dart';
import '../../../../core/utiles/GreenCircle.dart';
import '../../../../core/utiles/constans.dart';
import 'Widget/Button.dart';


class ConfirmationBallPool extends StatefulWidget {
  ConfirmationBallPool({super.key});

  @override
  State<ConfirmationBallPool> createState() => _ConfirmationBallPoolState();
}

class _ConfirmationBallPoolState extends State<ConfirmationBallPool> {
  int selected = 0;
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => AttachTransferBallPool(),
                      ),
                    );
                  },
                  child: Text(
