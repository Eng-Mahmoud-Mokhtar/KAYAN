...
import 'BallPoolSubscribe.dart';


class BallPoolDetails extends StatefulWidget {
  final String BallPoolName;
  final String location;
  final String price;
  final String imagePath;
  const BallPoolDetails({
    required this.BallPoolName,
  ...
  @override
  State<BallPoolDetails> createState() => _BallPoolDetailsState();
}
class _BallPoolDetailsState extends State<BallPoolDetails> {
  int _rating = 5;
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const BallPoolSubscribe(),
                    ),
                  );
                },
                child: Container(
  ...
  Widget _buildFeatures() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.end,
        children: [
          _buildFeatureRow('موجود', 'طاولات بلياردو عالية الجودة'),
          _buildFeatureRow('موجود', 'إضاءة مثالية للطاولة'),
          _buildFeatureRow('موجود', 'كرات بلياردو احترافية'),
          _buildFeatureRow('موجود', 'خدمات المشروبات والطعام'),
          _buildFeatureRow('غير موجود', 'خدمة تأجير المعدات'),
        ],
      ),
    );
  }
        ...
        children: [
          Container(
            ...
            child: ListView(
              scrollDirection: Axis.horizontal,
              children: [
                _buildImage('images/New/medium-shot-happy-guy-with-grey-vest.jpg'),
                _buildImage('images/New/medium-shot-man-holding-pool-cue-ball.jpg'),
              ],
            ),
          ),
        ],
