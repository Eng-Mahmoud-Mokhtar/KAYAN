...
class FavProductDetails extends StatefulWidget {
  final String title;
  ...
  @override
  _FavProductDetailsState createState() => _FavProductDetailsState();
}

class _FavProductDetailsState extends State<FavProductDetails> {
