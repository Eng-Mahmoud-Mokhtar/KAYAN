...
import 'package:homepage/Feature/Academy/presentation/view_model/views/widgets/Button.dart';
import 'package:image_picker/image_picker.dart';
import '../../../../../Gym/presentation/view_model/views/widgets/Wait_message.dart';
import 'UploudDetailsAcademy.dart';


class AttachTransferAcademy extends StatefulWidget {
  const AttachTransferAcademy({super.key});
  @override
  State<AttachTransferAcademy> createState() => _AttachTransferAcademyState();
}

class _AttachTransferAcademyState extends State<AttachTransferAcademy> {
