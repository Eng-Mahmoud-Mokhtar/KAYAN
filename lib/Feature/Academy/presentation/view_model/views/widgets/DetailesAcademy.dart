...
import 'package:homepage/Feature/Academy/presentation/view_model/views/subscription.dart';
import 'package:video_player/video_player.dart';
import '../../../../../../core/colors.dart';
import '../../../../../core/utiles/constans.dart';

class DetailsAcademy extends StatefulWidget {
  final String AcademyName;
  final String location;
  final String price;
  final String imagePath;
  const DetailsAcademy({
  ...
  @override
  State<DetailsAcademy> createState() => _DetailsAcademyState();
}

class _DetailsAcademyState extends State<DetailsAcademy> {
  int _rating = 5;
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SubscriptionAcademy(
        ...
        children: [
          Container(
            ...
            child: ListView(
              scrollDirection: Axis.horizontal,
              children: [
                _buildImage('images/Gym/sportsman-doing-squats-gym.jpg'),
                _buildImage('images/Gym/young-sportive-man-is-doing-exercises-with-dumbbells-empty-gym-club.jpg'),
                _buildImage('images/Gym/sportsman-doing-squats-gym.jpg'),
                _buildImage('images/Gym/young-sportive-man-is-doing-exercises-with-dumbbells-empty-gym-club.jpg'),
              ],
            ),
