...
class ConfirmationAcademy extends StatefulWidget {
  ConfirmationAcademy({super.key});

  @override
  State<ConfirmationAcademy> createState() => _ConfirmationAcademyState();
}

class _ConfirmationAcademyState extends State<ConfirmationAcademy> {
  int selected = 0;
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => AttachTransferAcademy(),
                      ),
                    );
                  },
                  child: Text(
...
class Add extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final double screenWidth = MediaQuery.of(context).size.width;
    final double textSizeTitle = screenWidth * 0.06;
