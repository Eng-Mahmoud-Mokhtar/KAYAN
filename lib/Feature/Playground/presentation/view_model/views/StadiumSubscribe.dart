...
class StadiumSubscribe extends StatefulWidget {
  const StadiumSubscribe({super.key});
  @override
  State<StadiumSubscribe> createState() => _StadiumSubscribeState();
}

class _StadiumSubscribeState extends State<StadiumSubscribe> {
