...
import 'package:homepage/Feature/NearbyPlaygrpund/presentation/view_model/views/widgets/transferNearby.dart';
import '../../../../../core/utiles/GreenCircle.dart';
import '../../../../../core/utiles/constans.dart';
import 'ButtonNearby.dart';

class ConfirmationNearby extends StatefulWidget {
  ConfirmationNearby({super.key});

  @override
  State<ConfirmationNearby> createState() => _ConfirmationNearbyState();
}

class _ConfirmationNearbyState extends State<ConfirmationNearby> {
  int selected = 0;
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => AttachTransferNearby(),
                      ),
                    );
                  },
                  child: Text(
