...
import 'confirmationNearby.dart';

class NearbySubscribe extends StatefulWidget {
  const NearbySubscribe({super.key});
  @override
  State<NearbySubscribe> createState() => _NearbySubscribeState();
}

class _NearbySubscribeState extends State<NearbySubscribe> {
                ...
                onPressed: () {
                  ...
                  if (selectedDay != null && selectedTime != null) {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => ConfirmationNearby(),
                      ),
                    );
                  } else {
