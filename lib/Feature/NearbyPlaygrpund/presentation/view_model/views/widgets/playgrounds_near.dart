...
class PlaygroundsNear extends StatefulWidget {
  const PlaygroundsNear({super.key});

  @override
  State<PlaygroundsNear> createState() => _PlaygroundsNearState();
}

class _PlaygroundsNearState extends State<PlaygroundsNear> {
