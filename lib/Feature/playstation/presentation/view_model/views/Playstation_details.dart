...
import 'PlaystationSubscribe.dart';

class PlaystationDetails extends StatefulWidget {
  final String PlaystationName;
  final String location;
  final String price;
  final String imagePath;
  const PlaystationDetails({
  ...
  @override
  State<PlaystationDetails> createState() => _PlaystationDetailsState();
}
class _PlaystationDetailsState extends State<PlaystationDetails> {
  int _rating = 5;
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const PlaystationSubscribe(),
                    ),
                  );
                },
                child: Container(
  ...
  Widget _buildFeatures() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.end,
        children: [
          _buildFeatureRow('موجود', 'دقة 4K Ultra HD'),
          _buildFeatureRow('موجود', 'توافق مع ألعاب الجيل السابق'),
          _buildFeatureRow('موجود', 'تحكم لاسلكي'),
          _buildFeatureRow('موجود', 'دعم تقنية الواقع الافتراضي'),
          _buildFeatureRow('غير موجود', 'مستشعر بصمة الإصبع'),
        ],
      ),
    );
  }
        ...
        children: [
          Container(
            ...
            child: ListView(
              scrollDirection: Axis.horizontal,
              children: [
                _buildImage('images/New/gamification-3d-rendering-concept.jpg'),
                _buildImage('images/New/front-view-father-girl-playing-videogame.jpg'),
              ],
            ),
          ),
        ],
