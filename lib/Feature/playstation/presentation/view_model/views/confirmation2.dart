...
import 'package:homepage/Feature/playstation/presentation/view_model/views/transfer_amount.dart';
import '../../../../core/utiles/GreenCircle.dart';
import '../../../../core/utiles/constans.dart';
import 'Widget/Button.dart';


class PlaystationConfirmation extends StatefulWidget {
  PlaystationConfirmation({super.key});

  @override
  State<PlaystationConfirmation> createState() => _PlaystationConfirmationState();
}

class _PlaystationConfirmationState extends State<PlaystationConfirmation> {
  int selected = 0;
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => AttachTransferPlaystation(),
                      ),
                    );
                  },
                  child: Text(
