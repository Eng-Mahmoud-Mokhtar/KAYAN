...
import 'package:homepage/Feature/Gym/presentation/view_model/views/widgets/amount.dart';
import '../../../../../core/utiles/GreenCircle.dart';
import '../../../../../core/utiles/constans.dart';
import '../widgets/Button.dart';

class ConfirmationGym extends StatefulWidget {
  ConfirmationGym({super.key});

  @override
  State<ConfirmationGym> createState() => _ConfirmationGymState();
}

class _ConfirmationGymState extends State<ConfirmationGym> {
  int selected = 0;
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => AttachTransferGym(),
                      ),
                    );
                  },
                  child: Text(
...
class Add extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final double screenWidth = MediaQuery.of(context).size.width;
    final double textSizeTitle = screenWidth * 0.05;
