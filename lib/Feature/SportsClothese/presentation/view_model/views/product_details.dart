...
class SportClotheseDetails extends StatefulWidget {
  final String title;
  final String urlImage;
  final String price;
  final String details;

  SportClotheseDetails({
    required this.title,
  ...
  @override
  _SportClotheseDetailsState createState() => _SportClotheseDetailsState();
}

class _SportClotheseDetailsState extends State<SportClotheseDetails> {
                      ...
                      Row(
                        children: availableColors.map((color) {
                          return GestureDetector(
                            ...
                            child: Container(
                              margin: EdgeInsets.symmetric(horizontal: screenWidth * 0.02), // مسافة بين الألوان
